...
public class LOLS_Grid : MonoBehaviour
{
    ...
    public List<Vector3> GetNeighborCells(Vector3 _cell)
    {
        ...
        {
            Vector3 neighborCell = _cell + offset;
            if (IsCellInGrid(neighborCell))
            {
    ...
    private bool IsCellInGrid(Vector3 cell)
    {
        return cell.x >= 0 && cell.x < gridSizeX && cell.y >= 0 && cell.y < gridSizeY && cell.z >= 0 && cell.z < gridSizeZ;
    }
